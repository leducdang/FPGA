...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../spi.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81048
SOPC_SYSID_FLAG += --sidp=0x81048
ELF_PATCH_FLAG  += --sidp 0x81048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1729135030
SOPC_SYSID_FLAG += --timestamp=1729135030
ELF_PATCH_FLAG  += --timestamp 1729135030

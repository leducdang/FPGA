...
module ed_synth_ed_synth_emif (
	...
	ed_synth_ed_synth_emif_phy #(
		...
		.PLL_INCLK0_PERIOD_PS          (20000),
		.PLL_INTENDED_DEVICE_FAMILY    ("Cyclone IV E"),
		.PLL_VCO_PHASE_SHIFT_STEP      (125)
	) phy (
	...
	ed_synth_ed_synth_emif_status_bridge #(
		.LOCAL_SIZE_WIDTH                 (3),
		.LOCAL_ADDR_WIDTH                 (24),
		.LOCAL_DATA_WIDTH                 (16),
		.LOCAL_BE_WIDTH                   (2),

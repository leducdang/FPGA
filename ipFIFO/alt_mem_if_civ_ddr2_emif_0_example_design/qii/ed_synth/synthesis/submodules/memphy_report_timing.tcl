...
set corename "amp_phy"

##############################################################
## Some useful functions
##############################################################
source "[list [file join [file dirname [info script]] memphy_ddr_timing.tcl]]"
source "[list [file join [file dirname [info script]] memphy_ddr_pins.tcl]]"
source "[list [file join [file dirname [info script]] memphy_report_timing_core.tcl]]"
...
for {set inst_index 0} {$inst_index != [llength $instance_names]} {incr inst_index} {
	...
	# TODO: Does this solve tg unconstrained paths?!?!
	if { ! $entity_names_on } {

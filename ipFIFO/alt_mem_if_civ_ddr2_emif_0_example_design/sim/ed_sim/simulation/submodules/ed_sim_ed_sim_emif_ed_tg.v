...
`timescale 1 ps / 1 ps
module ed_sim_ed_sim_emif_ed_tg #(
		parameter DEVICE_FAMILY                          = "Cyclone IV E",
		parameter TG_AVL_DATA_WIDTH                      = 16,
		parameter TG_AVL_ADDR_WIDTH                      = 24,
		parameter TG_AVL_WORD_ADDR_WIDTH                 = 24,
		parameter TG_AVL_SIZE_WIDTH                      = 3,
		parameter TG_AVL_BE_WIDTH                        = 2,
		parameter DRIVER_SIGNATURE                       = 1431634141,
		parameter TG_GEN_BYTE_ADDR                       = 0,
		...
		output wire [15:0] pnf_per_bit,         //       pnf.pnf_per_bit
		...
		output wire [15:0] avl_wdata,           //          .writedata
		input  wire [15:0] avl_rdata,           //          .readdata
		output wire        avl_write_req,       //          .write
		output wire        avl_read_req,        //          .read
		input  wire        avl_rdata_valid,     //          .readdatavalid
		output wire [1:0]  avl_be,              //          .byteenable
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634141)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;

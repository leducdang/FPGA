...
# ----------------------------------------------------------------
	...
	for {set i 0} {$i < $dqsgroups} {incr i} {
		set dqs ${instname}|dpio|dqs\[$i\].dqs_ddio_out|dataout
		set dq  ${instname}|dpio|dqs_group\[$i\].dq\[*\].dq_ddio_out|dataout
		set dm  ${instname}|dpio|dm\[$i\].dm_ddio_out|dataout
	...
	set patterns [list]
	lappend patterns addrcmd ${instname}|*adc*|addr\[*\].addr_struct|*_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}|*adc*|ba\[*\].ba_struct|*_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}|*adc*|cas_n_struct|*_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}|*adc*|ras_n_struct|*_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd ${instname}|*adc*|we_n_struct|*_rate.addr_pin|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns addrcmd    ${instname}|*adc*|cke\[*\].cke_struct|*_rate.addr_pin|auto_generated|ddio_outa\[0\]|dataout
	lappend patterns addrcmd    ${instname}|*adc*|gen_odt.odt\[*\].odt_struct|*_rate.addr_pin|auto_generated|ddio_outa\[0\]|dataout
	lappend patterns addrcmd    ${instname}|*adc*|cs_n\[*\].cs_n_struct|*_rate.addr_pin|auto_generated|ddio_outa\[0\]|dataout
	lappend patterns ck_p ${instname}|clk|DDR_CLK_OUT\[*\].ddr_clk_out_p|auto_generated|ddio_outa\[*\]|dataout
	lappend patterns ck_n ${instname}|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout

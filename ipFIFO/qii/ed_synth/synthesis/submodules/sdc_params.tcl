...
set ip_params(ALT_MEM_IF_SPEED_GRADE) "6"
set ip_params(ALT_MEM_IF_PLL_REFCLK_FREQ) "100.0"
set ip_params(ALT_MEM_IF_MEM_CLK_FREQ) "133.0"
...
set ip_params(MEM_MAX_MEM_FREQ) "133.0"
...
set ip_params(MEM_CAS_3_MAX_FREQ) "133.0"
set ip_params(MEM_CAS_4_MAX_FREQ) "133.0"
set ip_params(MEM_CAS_5_MAX_FREQ) "133.0"
set ip_params(MEM_CAS_6_MAX_FREQ) "133.0"
...
set ip_params(LOCAL_IF_CLK_MHZ) "133.0"
set ip_params(LOCAL_IF_CLK_PERIOD_PS) "7519"
set ip_params(MEM_TWR) "2"
set ip_params(PLL_REF_CLK_PERIOD_PS) "10000"
set ip_params(FAMILY) "Cyclone IV E"
set ip_params(MEM_IF_MEMTYPE) "DDR2"
set ip_params(LEVELLING) "0"
set ip_params(SPEED_GRADE) "C6"
...
set ip_params(MEM_IF_CLK_PS) "7519"
set ip_params(MEM_IF_CLK_PS_STR) "7519 ps"
...
set ip_params(PLL_STEPS_PER_CYCLE) "64"
...
set ip_params(PLL_CLK0_DIVIDE_BY) "3"
set ip_params(PLL_CLK0_MULTIPLY_BY) "2"
set ip_params(PLL_CLK0_PHASE_SHIFT_PS) "0"
set ip_params(PLL_CLK1_DIVIDE_BY) "100"
set ip_params(PLL_CLK1_MULTIPLY_BY) "133"
set ip_params(PLL_CLK1_PHASE_SHIFT_PS) "0"
set ip_params(PLL_CLK2_DIVIDE_BY) "100"
set ip_params(PLL_CLK2_MULTIPLY_BY) "133"
set ip_params(PLL_CLK2_PHASE_SHIFT_PS) "-1880"
set ip_params(PLL_CLK3_DIVIDE_BY) "100"
set ip_params(PLL_CLK3_MULTIPLY_BY) "133"
set ip_params(PLL_CLK3_PHASE_SHIFT_PS) "0"
set ip_params(PLL_CLK4_DIVIDE_BY) "100"
set ip_params(PLL_CLK4_MULTIPLY_BY) "133"
set ip_params(PLL_CLK4_PHASE_SHIFT_PS) "0"
set ip_params(PLL_INCLK0_PERIOD_PS) "10000"
set ip_params(PLL_INTENDED_DEVICE_FAMILY) "Cyclone IV E"
set ip_params(PLL_VCO_PHASE_SHIFT_STEP) "117"
...
set ::t(DSS) [expr double($ip_params(MEM_DQS_FALLING_EDGE_TO_CK_SETUP_TIME))]
set ::t(DSH) [expr double($ip_params(MEM_DQS_FALLING_EDGE_HOLD_TIME_FROM_CK))]
set ::t(DQSS) [expr double($ip_params(MEM_FIRST_DQS_EDGE_TO_ASSOC_CLOCK_EDGE))]
...
set corename ed_synth_ed_synth_emif_phy

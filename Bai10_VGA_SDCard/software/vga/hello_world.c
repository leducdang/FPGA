...
int count = 0;
int clorR, clorG, clorB, clorWhite;
int main()
{
...
//  				        		readCharacter2 = alt_up_sd_card_read(fileHandle);
//
//  				        		clorWhite = (readCharacter + readCharacter1 + readCharacter2)/3;
//
//  				 //----------------------    Tao Anh Mau   --------------------------------//
...
//
////  				        		pixel = clorWhite>>3;
////  				        		pixel = (pixel<<11)|((clorWhite>>2)<<5);
////  				        		pixel = pixel | (clorWhite>>3);
//
//  				        		++contentCount;
//  				        		j++;
//  				        		if(j>319){j = 0; i ++;}
//  				        		if(i>239)i = 0;
//  				        		alt_up_pixel_buffer_dma_draw_box (pixel_buf_dma_dev, (319 - j), (239 - i), (319 - j), (239 - i), pixel, 0);
//  				        	}
//  				        }
...
//            alt_up_pixel_buffer_dma_draw_box (pixel_buf_dma_dev, (319 - x), (239 - y), (319 - x), (239 - y), rgb565, 0);
            alt_up_pixel_buffer_dma_draw_box (pixel_buf_dma_dev, x, (239 - y), x, (239 - y), rgb565, 0);

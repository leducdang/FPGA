...
`timescale 1 ps / 1 ps
module SDCard_mm_interconnect_0 (
	...
	wire  [93:0] sdcard_avalon_sdcard_slave_agent_rf_source_data;                           // SDCard_avalon_sdcard_slave_agent:rf_source_data -> SDCard_avalon_sdcard_slave_agent_rsp_fifo:in_data
	...
	wire  [93:0] sdcard_avalon_sdcard_slave_agent_rsp_fifo_out_data;                        // SDCard_avalon_sdcard_slave_agent_rsp_fifo:out_data -> SDCard_avalon_sdcard_slave_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> SDCard_avalon_sdcard_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // SDCard_avalon_sdcard_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> SDCard_avalon_sdcard_slave_agent:cp_channel
	...
	wire  [92:0] debug_avalon_jtag_slave_agent_rp_data;                                     // debug_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [92:0] sdcard_avalon_sdcard_slave_agent_rp_data;                                  // SDCard_avalon_sdcard_slave_agent:rp_data -> router_003:sink_data
	...
	SDCard_mm_interconnect_0_router router (
	...
	SDCard_mm_interconnect_0_router router_001 (
	...
	SDCard_mm_interconnect_0_router_002 router_002 (
	...
	SDCard_mm_interconnect_0_router_002 router_003 (
	...
	SDCard_mm_interconnect_0_router_002 router_004 (
	...
	SDCard_mm_interconnect_0_router_002 router_005 (
	...
	SDCard_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDCard_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),

...
module uart_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [93:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> ram_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // ram_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> ram_s1_agent:cp_channel
	...
	wire  [93:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [93:0] ram_s1_agent_rp_data;                                                      // ram_s1_agent:rp_data -> router_003:sink_data
	...
	uart_mm_interconnect_0_router_004 router_004 (
	...
	uart_mm_interconnect_0_router_004 router_005 (
	...
	uart_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

	...
	if {($result == 1)} {
		...
		foreach dqsgroup $pins(dqsgroup) {
			...
			if {($IP(mem_if_memtype) == "DDR3 SDRAM") && ($IP(discrete_device) == 0)} {
				set dqs_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dqs_op_gen.dqs_op|dqs_ddio_out_gen.ddr3_opa_phase_align_gen.o_phase_align|clk
			} else {
				if {$::family == "arria ii"} {
					set dqs_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq_dqs|dqs_*_output_ddio_out_inst|muxsel
				} elseif {$::family == "cyclone iv"} {
					set dqs_periphery_node ${::instname}|dpio|dqs[${dqsgroup_number}].dqs_ddio_out|muxsel
				} elseif {($::family == "stratix iv") || ($::family == "hardcopy iii") || ($::family == "hardcopy iv")} {
					set dqs_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dqs_op_gen.dqs_op|dqs_ddio_out_gen.ddr_ddio_phase_align_gen.dqs_ddio_inst|muxsel
				}
			}
			...
			if {$::family == "arria ii"} {
				set output_buffer_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].ddr*_dqsn_*buf_gen.dqs_obuf|i
			} elseif {$::family == "cyclone iv"} {
				set output_buffer_node ${::instname}|dpio|dqs[${dqsgroup_number}].dqs_obuf|i		
			} elseif {($::family == "stratix iv") || ($::family == "hardcopy iii") || ($::family == "hardcopy iv")} {
				set output_buffer_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dqs_op_gen.dqs_op|obuf|i
			}
			...
			foreach dqpin $dqdqmpins {	
				...
				if {($IP(mem_if_memtype) == "DDR3 SDRAM") && ($IP(discrete_device) == 0)} {
					if {$isdqmpin == 0} {
						set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_pad|ddr3_dq_opa_gen.dq_opa_inst|clk
					} else {
						set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dm_gen.dm_pad_gen[${dqm_index}].dm_pad|ddr3_dm_opa_gen.dm_opa_inst|clk
					}
				} else {
					if {$::family == "arria ii"} {
						if {$isdqmpin == 0} {
							set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq_dqs|bidir_dq_${dq_index}_output_ddio_out_inst|muxsel
						} else {
							set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq_dqs|output_dq_${dqm_index}_output_ddio_out_inst|muxsel
						}				
					} elseif {$::family == "cyclone iv"} {
						if {$isdqmpin == 0} {
							set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_ddio_out|muxsel
						} else {
							set dq_periphery_node ${::instname}|dpio|dm[${dqsgroup_number}].dm_ddio_out|muxsel
						}	
					} elseif {($::family == "stratix iv") || ($::family == "hardcopy iii") || ($::family == "hardcopy iv")} {
						if {$isdqmpin == 0} {
							set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_pad|ddr_qdr_dq_ddio_out_gen.dq_ddio_inst|muxsel
						} else {
							set dq_periphery_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dm_gen.dm_pad_gen[${dqm_index}].dm_pad|ddr_qdr_dm_ddio_gen.dm_ddio_inst|muxsel
						}				
					}
				}
				...
				if {$::family == "arria ii"} {
					if {$isdqmpin == 0} {
						set output_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_obuf|i
					} else {
						set output_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].gen_dm.dm_obuf|i
					}
				} elseif {$::family == "cyclone iv"} {
					if {$isdqmpin == 0} {
						set output_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_obuf|i
					} else {
						set output_buffer_node_dq ${::instname}|dpio|dm[${dqsgroup_number}].dm_obuf|i
					}			
				} elseif {($::family == "stratix iv") || ($::family == "hardcopy iii") || ($::family == "hardcopy iv")} {
					if {$isdqmpin == 0} {
						set output_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_pad|gen_ddr_obuf.dq_obuf_inst|i
					} else {
						set output_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dm_gen.dm_pad_gen[${dqm_index}].dm_pad|dq_obuf_inst|i
					}
				}
...
proc perform_flexible_read_capture_timing_analysis {opcs opcname pin_array_name timing_parameters_array_name summary_name MP_name IP_name} {
	...
	if {($result == 1)} {
		...
		foreach dqsgroup $pins(dqsgroup) {
			...
			if {$::family == "arria ii"} {	
				set input_buffer_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].ddr*_dqsn_*buf_gen.dqs_inpt_ibuf|i
				...
				set input_buffer_node ${::instname}|dpio|dqs_group[${dqsgroup_number}].dqs_ip|ddr*_dqsn_ibuf_gen.dqs_inpt_io_ibuf|o
			...
			foreach dqpin $dqpins {	
				...
				if {$::family == "arria ii"} {
					set input_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_ibuf|i
					...
					set input_buffer_node_dq ${::instname}|dpio|dqs_group[${dqsgroup_number}].dq[${dq_index}].dq_pad|dqi_io_ibuf|o
...
proc perform_flexible_read_capture_non_dqs_timing_analysis {opcs opcname pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_parameters_name} {
	...
	set read_capture_clock_start ${::instname}|clk|pll|altpll_component|auto_generated|clk[3]~clkctrl|outclk
	set read_capture_clock_end   ${::instname}|dpio|dqs_group\[*\].dq\[*\].dqi|auto_generated|input_cell_*\[0\]|clk
	...
	if {($::is_gx == "true")} {
		...
		set DQ_path_period_jitter [expr [get_io_standard_node_delay -dst DQDQS_JITTER -io_standard $::io_std -parameters [list IO $::interface_type]]/1000.0]
		set DQ_path_period_jitter_prop [expr [get_io_standard_node_delay -dst DQDQS_JITTER_DIVISION -io_standard $::io_std -parameters [list IO $::interface_type]]/100.0]
		set setup_slack [expr $setup_slack - $DQ_path_period_jitter*$DQ_path_period_jitter_prop]
		set hold_slack  [expr $hold_slack  - $DQ_path_period_jitter*(1.0-$DQ_path_period_jitter_prop)]		
	}
	...
	# Remove SSN effects
	if {($::is_gx == "true")} {
		set total_ssi [expr $::SSN(pushout_i) + $::SSN(pullin_i)]
		set setup_slack [expr $setup_slack - 0.6*$total_ssi]
		set hold_slack  [expr $hold_slack  - 0.4*$total_ssi]
	} else {
...
proc perform_macro_resync_timing_analysis {opcs opcname pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_parameters_name} {
	...
	if {($::family == "arria ii") || ($::family == "stratix iv")} {
		if {$IP(mem_if_memtype) == "DDR3 SDRAM"} {
			if {($::family == "arria ii") || ($::family == "stratix iv")} {
				if {$::family == "arria ii"} {
					set beforeDQSbus ${::instname}|dpio|dqs_group[*].dq_dqs|dqs_*_inst|dqsbusout
					set afterDQSbus  ${::instname}|dpio|dqs_group[*].dq_dqs|bidir_dq_*_ddio_in_inst|clk
				} elseif {$::family == "stratix iv"} {
					set beforeDQSbus ${::instname}|dpio|dqs_group[*].dqs_ip|ddr*_dqs_enable_ctrl_gen.dqs_enable_atom|dqsbusout
					set afterDQSbus  ${::instname}|dpio|dqs_group[*].dq[*].dq_pad|ddr_dq_ddio_in_gen.dqi_ddio_in|clk
				}

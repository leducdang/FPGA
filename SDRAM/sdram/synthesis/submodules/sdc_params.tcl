...
set ip_params(ALT_MEM_IF_MEM_CLK_FREQ) "200.0"
...
set ip_params(DQS_OUT_MODE_INT) "3"
set ip_params(LOCAL_IF_CLK_MHZ) "200.0"
set ip_params(LOCAL_IF_CLK_PERIOD_PS) "5000"
set ip_params(MEM_TWR) "3"
...
set ip_params(DLL_DELAY_BUFFER_MODE) "HIGH"
set ip_params(DLL_DELAY_CHAIN_LENGTH) "12"
set ip_params(DQS_DELAY_CTL_WIDTH) "6"
set ip_params(DQS_OUT_MODE) "DELAY_CHAIN3"
set ip_params(DQS_PHASE) "9000"
set ip_params(DQS_PHASE_SETTING) "3"
...
set ip_params(MEM_IF_CLK_PS) "5000"
set ip_params(MEM_IF_CLK_PS_STR) "5000 ps"
set ip_params(MEM_IF_MR_0) "1074"
set ip_params(MEM_IF_MR_1) "1024"
set ip_params(MEM_IF_MR_2) "0"
set ip_params(MEM_IF_MR_3) "0"
set ip_params(MEM_IF_PRESET_RLAT) "0"
set ip_params(PLL_STEPS_PER_CYCLE) "48"
...
set ip_params(PLL_CLK2_PHASE_SHIFT_PS) "-1250"
...
set ip_params(PLL_VCO_PHASE_SHIFT_STEP) "104"
...
set corename sdram_alt_mem_if_civ_ddr2_emif_0_phy

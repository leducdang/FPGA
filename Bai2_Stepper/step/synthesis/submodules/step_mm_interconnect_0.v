...
module step_mm_interconnect_0 (
		...
		output wire        OUT2_s1_write,                         //                                .write
		input  wire [31:0] OUT2_s1_readdata,                      //                                .readdata
		output wire [31:0] OUT2_s1_writedata,                     //                                .writedata
		output wire        OUT2_s1_chipselect,                    //                                .chipselect
		output wire [1:0]  OUT3_s1_address,                       //                         OUT3_s1.address
		output wire        OUT3_s1_write,                         //                                .write
		input  wire [31:0] OUT3_s1_readdata,                      //                                .readdata
		output wire [31:0] OUT3_s1_writedata,                     //                                .writedata
		output wire        OUT3_s1_chipselect,                    //                                .chipselect
		output wire [1:0]  OUT4_s1_address,                       //                         OUT4_s1.address
		output wire        OUT4_s1_write,                         //                                .write
		input  wire [31:0] OUT4_s1_readdata,                      //                                .readdata
		output wire [31:0] OUT4_s1_writedata,                     //                                .writedata
		output wire        OUT4_s1_chipselect,                    //                                .chipselect
	...
	wire  [96:0] debug_avalon_jtag_slave_agent_rf_source_data;                              // DEBUG_avalon_jtag_slave_agent:rf_source_data -> DEBUG_avalon_jtag_slave_agent_rsp_fifo:in_data
	...
	wire  [96:0] debug_avalon_jtag_slave_agent_rsp_fifo_out_data;                           // DEBUG_avalon_jtag_slave_agent_rsp_fifo:out_data -> DEBUG_avalon_jtag_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> DEBUG_avalon_jtag_slave_agent:cp_data
	...
	wire  [31:0] out4_s1_agent_m0_readdata;                                                 // OUT4_s1_translator:uav_readdata -> OUT4_s1_agent:m0_readdata
	wire         out4_s1_agent_m0_waitrequest;                                              // OUT4_s1_translator:uav_waitrequest -> OUT4_s1_agent:m0_waitrequest
	wire         out4_s1_agent_m0_debugaccess;                                              // OUT4_s1_agent:m0_debugaccess -> OUT4_s1_translator:uav_debugaccess
	wire  [19:0] out4_s1_agent_m0_address;                                                  // OUT4_s1_agent:m0_address -> OUT4_s1_translator:uav_address
	wire   [3:0] out4_s1_agent_m0_byteenable;                                               // OUT4_s1_agent:m0_byteenable -> OUT4_s1_translator:uav_byteenable
	wire         out4_s1_agent_m0_read;                                                     // OUT4_s1_agent:m0_read -> OUT4_s1_translator:uav_read
	wire         out4_s1_agent_m0_readdatavalid;                                            // OUT4_s1_translator:uav_readdatavalid -> OUT4_s1_agent:m0_readdatavalid
	wire         out4_s1_agent_m0_lock;                                                     // OUT4_s1_agent:m0_lock -> OUT4_s1_translator:uav_lock
	wire  [31:0] out4_s1_agent_m0_writedata;                                                // OUT4_s1_agent:m0_writedata -> OUT4_s1_translator:uav_writedata
	wire         out4_s1_agent_m0_write;                                                    // OUT4_s1_agent:m0_write -> OUT4_s1_translator:uav_write
	wire   [2:0] out4_s1_agent_m0_burstcount;                                               // OUT4_s1_agent:m0_burstcount -> OUT4_s1_translator:uav_burstcount
	wire         out4_s1_agent_rf_source_valid;                                             // OUT4_s1_agent:rf_source_valid -> OUT4_s1_agent_rsp_fifo:in_valid
	wire  [96:0] out4_s1_agent_rf_source_data;                                              // OUT4_s1_agent:rf_source_data -> OUT4_s1_agent_rsp_fifo:in_data
	wire         out4_s1_agent_rf_source_ready;                                             // OUT4_s1_agent_rsp_fifo:in_ready -> OUT4_s1_agent:rf_source_ready
	wire         out4_s1_agent_rf_source_startofpacket;                                     // OUT4_s1_agent:rf_source_startofpacket -> OUT4_s1_agent_rsp_fifo:in_startofpacket
	wire         out4_s1_agent_rf_source_endofpacket;                                       // OUT4_s1_agent:rf_source_endofpacket -> OUT4_s1_agent_rsp_fifo:in_endofpacket
	wire         out4_s1_agent_rsp_fifo_out_valid;                                          // OUT4_s1_agent_rsp_fifo:out_valid -> OUT4_s1_agent:rf_sink_valid
	wire  [96:0] out4_s1_agent_rsp_fifo_out_data;                                           // OUT4_s1_agent_rsp_fifo:out_data -> OUT4_s1_agent:rf_sink_data
	wire         out4_s1_agent_rsp_fifo_out_ready;                                          // OUT4_s1_agent:rf_sink_ready -> OUT4_s1_agent_rsp_fifo:out_ready
	wire         out4_s1_agent_rsp_fifo_out_startofpacket;                                  // OUT4_s1_agent_rsp_fifo:out_startofpacket -> OUT4_s1_agent:rf_sink_startofpacket
	wire         out4_s1_agent_rsp_fifo_out_endofpacket;                                    // OUT4_s1_agent_rsp_fifo:out_endofpacket -> OUT4_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> OUT4_s1_agent:cp_valid
	wire  [95:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> OUT4_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // OUT4_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> OUT4_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> OUT4_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> OUT4_s1_agent:cp_endofpacket
	...
	wire  [19:0] out3_s1_agent_m0_address;                                                  // OUT3_s1_agent:m0_address -> OUT3_s1_translator:uav_address
	...
	wire  [96:0] out3_s1_agent_rf_source_data;                                              // OUT3_s1_agent:rf_source_data -> OUT3_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] out3_s1_agent_rsp_fifo_out_data;                                           // OUT3_s1_agent_rsp_fifo:out_data -> OUT3_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> OUT3_s1_agent:cp_valid
	wire  [95:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> OUT3_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // OUT3_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> OUT3_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> OUT3_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> OUT3_s1_agent:cp_endofpacket
	...
	wire  [19:0] out2_s1_agent_m0_address;                                                  // OUT2_s1_agent:m0_address -> OUT2_s1_translator:uav_address
	...
	wire  [96:0] out2_s1_agent_rf_source_data;                                              // OUT2_s1_agent:rf_source_data -> OUT2_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] out2_s1_agent_rsp_fifo_out_data;                                           // OUT2_s1_agent_rsp_fifo:out_data -> OUT2_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> OUT2_s1_agent:cp_valid
	wire  [95:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> OUT2_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // OUT2_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> OUT2_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> OUT2_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> OUT2_s1_agent:cp_endofpacket
	...
	wire  [19:0] out1_s1_agent_m0_address;                                                  // OUT1_s1_agent:m0_address -> OUT1_s1_translator:uav_address
	...
	wire  [96:0] out1_s1_agent_rf_source_data;                                              // OUT1_s1_agent:rf_source_data -> OUT1_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] out1_s1_agent_rsp_fifo_out_data;                                           // OUT1_s1_agent_rsp_fifo:out_data -> OUT1_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> OUT1_s1_agent:cp_valid
	wire  [95:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> OUT1_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // OUT1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> OUT1_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> OUT1_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> OUT1_s1_agent:cp_endofpacket
	...
	wire  [95:0] debug_avalon_jtag_slave_agent_rp_data;                                     // DEBUG_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire         out4_s1_agent_rp_valid;                                                    // OUT4_s1_agent:rp_valid -> router_004:sink_valid
	wire  [95:0] out4_s1_agent_rp_data;                                                     // OUT4_s1_agent:rp_data -> router_004:sink_data
	wire         out4_s1_agent_rp_ready;                                                    // router_004:sink_ready -> OUT4_s1_agent:rp_ready
	wire         out4_s1_agent_rp_startofpacket;                                            // OUT4_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         out4_s1_agent_rp_endofpacket;                                              // OUT4_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         out3_s1_agent_rp_valid;                                                    // OUT3_s1_agent:rp_valid -> router_005:sink_valid
	wire  [95:0] out3_s1_agent_rp_data;                                                     // OUT3_s1_agent:rp_data -> router_005:sink_data
	wire         out3_s1_agent_rp_ready;                                                    // router_005:sink_ready -> OUT3_s1_agent:rp_ready
	wire         out3_s1_agent_rp_startofpacket;                                            // OUT3_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         out3_s1_agent_rp_endofpacket;                                              // OUT3_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         out2_s1_agent_rp_valid;                                                    // OUT2_s1_agent:rp_valid -> router_006:sink_valid
	wire  [95:0] out2_s1_agent_rp_data;                                                     // OUT2_s1_agent:rp_data -> router_006:sink_data
	wire         out2_s1_agent_rp_ready;                                                    // router_006:sink_ready -> OUT2_s1_agent:rp_ready
	wire         out2_s1_agent_rp_startofpacket;                                            // OUT2_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         out2_s1_agent_rp_endofpacket;                                              // OUT2_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         out1_s1_agent_rp_valid;                                                    // OUT1_s1_agent:rp_valid -> router_007:sink_valid
	wire  [95:0] out1_s1_agent_rp_data;                                                     // OUT1_s1_agent:rp_data -> router_007:sink_data
	wire         out1_s1_agent_rp_ready;                                                    // router_007:sink_ready -> OUT1_s1_agent:rp_ready
	wire         out1_s1_agent_rp_startofpacket;                                            // OUT1_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         out1_s1_agent_rp_endofpacket;                                              // OUT1_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         out4_s1_agent_rdata_fifo_src_valid;                                        // OUT4_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] out4_s1_agent_rdata_fifo_src_data;                                         // OUT4_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         out4_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_002:in_0_ready -> OUT4_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> OUT4_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> OUT4_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // OUT4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> OUT4_s1_agent:rdata_fifo_sink_error
	wire         out3_s1_agent_rdata_fifo_src_valid;                                        // OUT3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] out3_s1_agent_rdata_fifo_src_data;                                         // OUT3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         out3_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> OUT3_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> OUT3_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> OUT3_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // OUT3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> OUT3_s1_agent:rdata_fifo_sink_error
	wire         out2_s1_agent_rdata_fifo_src_valid;                                        // OUT2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] out2_s1_agent_rdata_fifo_src_data;                                         // OUT2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         out2_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_004:in_0_ready -> OUT2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> OUT2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> OUT2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // OUT2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> OUT2_s1_agent:rdata_fifo_sink_error
	wire         out1_s1_agent_rdata_fifo_src_valid;                                        // OUT1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] out1_s1_agent_rdata_fifo_src_data;                                         // OUT1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         out1_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_005:in_0_ready -> OUT1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> OUT1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> OUT1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                         // OUT1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> OUT1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (out4_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (out4_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (out4_s1_agent_m0_read),                 //                         .read
		.uav_write              (out4_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (out4_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (out4_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (out4_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (out4_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (out4_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (out4_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (out4_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (OUT4_s1_address),                       //      avalon_anti_slave_0.address
		.av_write               (OUT4_s1_write),                         //                         .write
		.av_readdata            (OUT4_s1_readdata),                      //                         .readdata
		.av_writedata           (OUT4_s1_writedata),                     //                         .writedata
		.av_chipselect          (OUT4_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (OUT3_s1_write),                         //                         .write
		.av_readdata            (OUT3_s1_readdata),                      //                         .readdata
		.av_writedata           (OUT3_s1_writedata),                     //                         .writedata
		.av_chipselect          (OUT3_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (OUT2_s1_write),                         //                         .write
		.av_readdata            (OUT2_s1_readdata),                      //                         .readdata
		.av_writedata           (OUT2_s1_writedata),                     //                         .writedata
		.av_chipselect          (OUT2_s1_chipselect),                    //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (out4_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (out4_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (out4_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (out4_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (out4_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (out4_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (out4_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (out4_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (out4_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (out4_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (out4_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (out4_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (out4_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (out4_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (out4_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (out4_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (out4_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (out4_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (out4_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (out4_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (out4_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (out4_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (out4_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (out4_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (out4_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (out4_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),        //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),         //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),        //                .error
		.rdata_fifo_src_ready    (out4_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (out4_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (out4_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                    //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                      //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) out4_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                            //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (out4_s1_agent_rf_source_data),             //        in.data
		.in_valid          (out4_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (out4_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (out4_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (out4_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (out4_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (out4_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (out4_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (out4_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (out4_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	step_mm_interconnect_0_router router (
	...
	step_mm_interconnect_0_router router_001 (
	...
	step_mm_interconnect_0_router_002 router_002 (
	...
	step_mm_interconnect_0_router_002 router_003 (
	...
	step_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (out4_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (out4_s1_agent_rp_valid),                //          .valid
		.sink_data          (out4_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (out4_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (out4_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_router_002 router_005 (
	...
	step_mm_interconnect_0_router_002 router_006 (
	...
	step_mm_interconnect_0_router_002 router_007 (
	...
	step_mm_interconnect_0_router_002 router_008 (
	...
	step_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	step_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	step_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (out4_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (out4_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (out4_s1_agent_rdata_fifo_src_ready),    //         .ready

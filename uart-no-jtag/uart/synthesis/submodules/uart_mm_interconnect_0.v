...
module uart_mm_interconnect_0 (
	...
	wire  [95:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // cpu_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [4:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> ram_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> uart_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // uart_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> uart_s1_agent:cp_channel
	...
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> led1_s1_agent:cp_valid
	wire  [95:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> led1_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // led1_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> led1_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> led1_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> led1_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> led2_s1_agent:cp_valid
	wire  [95:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> led2_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // led2_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> led2_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> led2_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> led2_s1_agent:cp_endofpacket
	...
	wire  [95:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [95:0] ram_s1_agent_rp_data;                                                      // ram_s1_agent:rp_data -> router_003:sink_data
	...
	wire         uart_s1_agent_rp_valid;                                                    // uart_s1_agent:rp_valid -> router_004:sink_valid
	wire  [95:0] uart_s1_agent_rp_data;                                                     // uart_s1_agent:rp_data -> router_004:sink_data
	wire         uart_s1_agent_rp_ready;                                                    // router_004:sink_ready -> uart_s1_agent:rp_ready
	wire         uart_s1_agent_rp_startofpacket;                                            // uart_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         uart_s1_agent_rp_endofpacket;                                              // uart_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         led1_s1_agent_rp_valid;                                                    // led1_s1_agent:rp_valid -> router_005:sink_valid
	wire  [95:0] led1_s1_agent_rp_data;                                                     // led1_s1_agent:rp_data -> router_005:sink_data
	wire         led1_s1_agent_rp_ready;                                                    // router_005:sink_ready -> led1_s1_agent:rp_ready
	wire         led1_s1_agent_rp_startofpacket;                                            // led1_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         led1_s1_agent_rp_endofpacket;                                              // led1_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         led2_s1_agent_rp_valid;                                                    // led2_s1_agent:rp_valid -> router_006:sink_valid
	wire  [95:0] led2_s1_agent_rp_data;                                                     // led2_s1_agent:rp_data -> router_006:sink_data
	wire         led2_s1_agent_rp_ready;                                                    // router_006:sink_ready -> led2_s1_agent:rp_ready
	wire         led2_s1_agent_rp_startofpacket;                                            // led2_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         led2_s1_agent_rp_endofpacket;                                              // led2_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         uart_s1_agent_rdata_fifo_src_valid;                                        // uart_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] uart_s1_agent_rdata_fifo_src_data;                                         // uart_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         uart_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_002:in_0_ready -> uart_s1_agent:rdata_fifo_src_ready
	...
	wire         led1_s1_agent_rdata_fifo_src_valid;                                        // led1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] led1_s1_agent_rdata_fifo_src_data;                                         // led1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         led1_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> led1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> led1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> led1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // led1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> led1_s1_agent:rdata_fifo_sink_error
	wire         led2_s1_agent_rdata_fifo_src_valid;                                        // led2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] led2_s1_agent_rdata_fifo_src_data;                                         // led2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         led2_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_004:in_0_ready -> led2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> led2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> led2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // led2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> led2_s1_agent:rdata_fifo_sink_error
	...
	uart_mm_interconnect_0_router router (
	...
	uart_mm_interconnect_0_router_001 router_001 (
	...
	uart_mm_interconnect_0_router_002 router_002 (
	...
	uart_mm_interconnect_0_router_002 router_003 (
	...
	uart_mm_interconnect_0_router_002 router_004 (
	...
	uart_mm_interconnect_0_router_005 router_005 (
	...
	uart_mm_interconnect_0_router_005 router_006 (
	...
	uart_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),

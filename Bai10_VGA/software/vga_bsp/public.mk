...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../vga.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4041840
SOPC_SYSID_FLAG += --sidp=0x4041840
ELF_PATCH_FLAG  += --sidp 0x4041840

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1731115541
SOPC_SYSID_FLAG += --timestamp=1731115541
ELF_PATCH_FLAG  += --timestamp 1731115541

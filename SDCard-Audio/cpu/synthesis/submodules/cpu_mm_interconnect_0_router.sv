...
(
    ...
    localparam PAD5 = log2ceil(64'h41848 - 64'h41840); 
    localparam PAD6 = log2ceil(64'h41850 - 64'h41848); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h41850;
    ...
    // ( 0x41840 .. 0x41848 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 19'h41840  && write_transaction  ) begin
            src_channel = 7'b0001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x41848 .. 0x41850 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 19'h41848   ) begin

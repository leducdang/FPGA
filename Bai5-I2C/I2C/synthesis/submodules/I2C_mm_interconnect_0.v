...
module I2C_mm_interconnect_0 (
	...
	wire  [96:0] i2c_csr_agent_rf_source_data;                                              // I2C_csr_agent:rf_source_data -> I2C_csr_agent_rsp_fifo:in_data
	...
	wire  [96:0] i2c_csr_agent_rsp_fifo_out_data;                                           // I2C_csr_agent_rsp_fifo:out_data -> I2C_csr_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> I2C_csr_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // I2C_csr_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> I2C_csr_agent:cp_channel
	...
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> CPU_debug_mem_slave_agent:cp_channel
	...
	wire  [95:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [95:0] i2c_csr_agent_rp_data;                                                     // I2C_csr_agent:rp_data -> router_004:sink_data
	...
	wire  [95:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [95:0] cmd_demux_001_src3_data;                                                   // cmd_demux_001:src3_data -> cmd_mux_004:sink1_data
	...
	wire  [95:0] rsp_demux_004_src1_data;                                                   // rsp_demux_004:src1_data -> rsp_mux_001:sink3_data

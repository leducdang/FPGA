...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../I2C.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81118
SOPC_SYSID_FLAG += --sidp=0x81118
ELF_PATCH_FLAG  += --sidp 0x81118

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1730797485
SOPC_SYSID_FLAG += --timestamp=1730797485
ELF_PATCH_FLAG  += --timestamp 1730797485

...
`timescale 1 ps / 1 ps
module led_blink_mm_interconnect_0 (
	...
	wire  [19:0] lcd_avalon_lcd_slave_agent_m0_address;                                              // lcd_avalon_lcd_slave_agent:m0_address -> lcd_avalon_lcd_slave_translator:uav_address
	...
	wire  [69:0] lcd_avalon_lcd_slave_agent_rf_source_data;                                          // lcd_avalon_lcd_slave_agent:rf_source_data -> lcd_avalon_lcd_slave_agent_rsp_fifo:in_data
	...
	wire  [69:0] lcd_avalon_lcd_slave_agent_rsp_fifo_out_data;                                       // lcd_avalon_lcd_slave_agent_rsp_fifo:out_data -> lcd_avalon_lcd_slave_agent:rf_sink_data
	...
	wire  [95:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [95:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> button_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> button_s1_agent:cp_channel
	...
	wire  [68:0] lcd_avalon_lcd_slave_agent_rp_data;                                                 // lcd_avalon_lcd_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [95:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [95:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [68:0] lcd_avalon_lcd_slave_burst_adapter_source0_data;                                    // lcd_avalon_lcd_slave_burst_adapter:source0_data -> lcd_avalon_lcd_slave_agent:cp_data
	...
	wire   [5:0] lcd_avalon_lcd_slave_burst_adapter_source0_channel;                                 // lcd_avalon_lcd_slave_burst_adapter:source0_channel -> lcd_avalon_lcd_slave_agent:cp_channel
	...
	wire  [95:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_004:sink1_data
	...
	wire  [95:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [68:0] router_003_src_data;                                                                // router_003:src_data -> lcd_avalon_lcd_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                               // lcd_avalon_lcd_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [5:0] router_003_src_channel;                                                             // router_003:src_channel -> lcd_avalon_lcd_slave_rsp_width_adapter:in_channel
	...
	wire  [95:0] lcd_avalon_lcd_slave_rsp_width_adapter_src_data;                                    // lcd_avalon_lcd_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire   [5:0] lcd_avalon_lcd_slave_rsp_width_adapter_src_channel;                                 // lcd_avalon_lcd_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [95:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> lcd_avalon_lcd_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                              // lcd_avalon_lcd_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> lcd_avalon_lcd_slave_cmd_width_adapter:in_channel
	...
	wire  [68:0] lcd_avalon_lcd_slave_cmd_width_adapter_src_data;                                    // lcd_avalon_lcd_slave_cmd_width_adapter:out_data -> lcd_avalon_lcd_slave_burst_adapter:sink0_data
	...
	wire   [5:0] lcd_avalon_lcd_slave_cmd_width_adapter_src_channel;                                 // lcd_avalon_lcd_slave_cmd_width_adapter:out_channel -> lcd_avalon_lcd_slave_burst_adapter:sink0_channel
	...
	led_blink_mm_interconnect_0_router router (
	...
	led_blink_mm_interconnect_0_router_001 router_001 (
	...
	led_blink_mm_interconnect_0_router_002 router_002 (
	...
	led_blink_mm_interconnect_0_router_003 router_003 (
	...
	led_blink_mm_interconnect_0_router_002 router_004 (
	...
	led_blink_mm_interconnect_0_router_005 router_005 (
	...
	led_blink_mm_interconnect_0_router_002 router_006 (
	...
	led_blink_mm_interconnect_0_router_005 router_007 (
	...
	led_blink_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),           // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	led_blink_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

...
try:
    ...
    #         # print(f"{cnt:6d} | raw={raw:10d} | mfcc={val:.6f}")
    #         print(val)
    ...
    np.savetxt("img.txt", samples, fmt="%d")
    # np.savetxt("q810_float1.txt", float_arr, fmt="%.6f")
    # np.savetxt("imgConv1.txt", float_arr, fmt="%.6f")
    # np.savetxt("img.txt", float_arr, fmt="%.6f")
